...
import com.wd.tech.activity.adapter.FindFriendGroupListAdapter;
...
//    private String sessionId;
    ...
    private DeleteFriendGroupPresenter deleteFriendGroupPresenter;
    ...
    protected void initView() {
        ...
        findFriendGroupListAdapter.setOnItemClickListener2(new FindFriendGroupListAdapter.ClickListener2() {
            @Override
            public void click2(final int id) {
                final EditText et = new EditText(CheckGroupActivity.this);
                new AlertDialog.Builder(CheckGroupActivity.this).setTitle("修改好友分组名称")
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.check_group_new_group:
                ...
                new AlertDialog.Builder(this).setTitle("添加新分组")
                        .setIcon(android.R.drawable.ic_dialog_info)
                        .setView(et)
                        .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
    ...
    class NewGroup implements ICoreInfe<Result> {
