...
public class InviteFriendsActivity extends WDActivity {
        ...
        switch (view.getId()) {
            ...
            case R.id.text_yaoqing:
                ...
                for(int i=0;i<size;i++){
                    array[i]=(int)sum.get(i);

                }
                presenter.request(userId,sessionId,groupId,array);
    ...
    class MyExpandableListView extends BaseExpandableListAdapter {
        ...
        public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                holder = new MyExpandableListView.MyHolder();
    ...
    private class AA implements ICoreInfe<Result> {
        @Override
